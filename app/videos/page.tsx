      ...
      */}
      <main className="mx-auto max-w-6xl px-4 py-8">
          ...
          <div className="space-y-6">
            {videos.map((video) => {
              ...
              return (
                <div
                  key={video.id}
                  className={`bg-gray-900 border rounded-lg p-6 ${expired ? 'border-gray-800 opacity-60' : 'border-gray-800'
                    }`}
                >
                  {/* Video Header */}
                  ...
                  */}
                  ...
                  <div className="mb-4 flex items-center gap-3">
                    <button
                      ...
                      disabled={expired}
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${expired
                        ...
                        (type) => {
                          ...
                          return (
                            <button
                              ...
                              disabled={expired}
                              className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${expired
                                ? 'bg-gray-800 text-gray-600 cursor-not-allowed'
                                : 'bg-gray-800 hover:bg-gray-700 text-white'
                                }`}
                  ...
                  <div className="border-t border-gray-800 pt-4">
                    ...
                    >
                      {selectedVideo === video.id
                        ? '▼ Hide'
                        : `▶ Show ${video.commentCount} field note${video.commentCount !== 1 ? 's' : ''
                        }`}
                    </button>
        ...
        {/* Message Display */}
        {
          message && (
            <div
              className={`fixed bottom-4 right-4 p-4 rounded-lg shadow-lg ${message.includes('✓')
